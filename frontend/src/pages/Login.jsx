  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-950 p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[60%] -right-[10%] w-[40%] h-[40%] rounded-full bg-fuchsia-600/20 blur-[120px]" />
      </div>
      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl bg-white/80 p-8 shadow-2xl backdrop-blur-xl dark:bg-slate-900/80 border border-white/20 dark:border-slate-800">
        <div className="mb-10 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-tr from-violet-600 to-fuchsia-600 shadow-lg">
            <Lock className="h-6 w-6 text-white" />
          </div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Welcome back</h1>
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Sign in to continue to Taskora</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
          ...
          <Link to="/signup" className="font-semibold text-violet-600 transition hover:text-violet-500 dark:text-violet-400">
            Sign up
          </Link>
        </p>
      </div>
